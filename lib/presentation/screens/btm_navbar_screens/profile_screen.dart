  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Padding(
        ...
        child: context.watch<AuthProvider>().currentUser != null
            ? Column(
                                  ...
                                  return GalleryItemView(
                                      onTap: () {
                                        Navigator.pushNamed(
                                            ...
                                            arguments:
                                                provider.favWallpaper[index]);
                                      },
                                      imageUrl: provider
                                          .favWallpaper[index].src!.original);
                                });
                          },
                          fallback: (BuildContext context) {
                            if (provider.listenSate ==
                                ListenDataSates.loading) {
